...
load("../output/feature_train_xgb.RData")
feat_train <- dat_train$feature
label_train <- dat_train$label
...
if(run.cv){
  ...
  save(err_cv_xgboost, file="../output/err_cv_xgboost_xgb.RData")
}

load("../output/err_cv_xgboost_xgb.RData")
err_cv_xgboost
```
...
save(fit_train, file="../output/fit_train_xgboost_xgb.RData")

load("../output/fit_train_xgboost_xgb.RData")
```
