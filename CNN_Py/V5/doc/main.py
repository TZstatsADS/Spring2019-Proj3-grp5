...
import sys
sys.path.append('/Users/elena/Documents/GitHub/Spring2019-Proj3-spring2019-proj3-grp5/CNN_Py/V4/lib/feature1_images_for_training.py')
...
#path = "/Users/elena/Desktop/AppDS/Project 3_SR/Spider_local_project"
os.chdir(path)
...
HR_cropped =f1.cropped_imgs(hr_paths)
len_HR = len(HR_cropped)/10
x_train_lr, x_train_hr, x_test_lr, x_test_hr =f2.train_test_data(HR_cropped, number_of_images = len_HR)

x_train_lr = f2.ndarray_to_4dim(x_train_lr, image_size = 8)
x_train_hr = f2.ndarray_to_4dim(x_train_hr, image_size = 32)
x_test_lr = f2.ndarray_to_4dim(x_test_lr, image_size = 8)
